...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/projetos$1.0.0/src/app/views/lista/form.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("<html><body><h1>Cadastro de livros</h1><form action=/livros method=post><input type=hidden id=id name=id><div><label for=titulo>Titulo:</label><input type=text" +
...
marko_template.meta = {
    id: "/projetos$1.0.0/src/app/views/lista/form.marko",
    tags: [
